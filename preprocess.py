...
def clean_text(text):
    ...
    # ignoring characters that aren't valid UTF-8
...
def process_posts(raw_file_path, processed_file_path=None):
    with open(raw_file_path, encoding='utf-8') as file:
        ...
        enriched_posts = []
        for post in posts:
            safe_text = clean_text(post['text'])
...
def extract_metadata(post):
    template = '''
    You are given a LinkedIn post. You need to extract name, number of lines, language of the post and tags.
